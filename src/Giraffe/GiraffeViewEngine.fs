...
// (values for aria- and role attributes obtained from
//  http://w3c.github.io/html/infrastructure.html#element-attrdef-aria-role)
module Accessibility =
    ...
    let _ariaDialog           = attr "aria-dialog"
